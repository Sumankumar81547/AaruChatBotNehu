...
from Aaru import BOT_NAME, Ravan, dev
from Aaru.database.chats import add_served_chat
from Aaru.database.users import add_served_user
...
async def help(client: Ravan, m: Message):
    if m.chat.type == ChatType.PRIVATE:
